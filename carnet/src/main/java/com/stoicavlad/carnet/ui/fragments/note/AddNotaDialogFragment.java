package com.stoicavlad.carnet.ui.fragments.note;
...
public class AddNotaDialogFragment extends DialogFragment implements Button.OnClickListener{
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        SpinnerAdapter mAdapter =   new ArrayAdapter<String>(getActivity(),
                android.R.layout.simple_list_item_1, android.R.id.text1, noteDatabase.getMaterii());
